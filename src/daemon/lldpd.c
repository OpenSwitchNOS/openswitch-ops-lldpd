...
#ifdef OPS
static void
snmp_statistics(struct lldpd_hardware *hardware) {
    ...
    char inserts_string[20],deletes_string[20],ageouts_string[20],drops_string[20];
    snprintf(inserts_string, 20, "%lu",inserts);
    snprintf(deletes_string, 20, "%lu", deletes);
    snprintf(ageouts_string, 20, "%lu", ageouts);
    snprintf(drops_string, 20, "%lu", drops);
    send_lldpRemTablesChange(idl, inserts_string, deletes_string, drops_string, ageouts_string);
}
#endif
