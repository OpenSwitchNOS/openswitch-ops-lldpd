...
lldpd_send_lldpRemTablesChange_trap(struct lldpd_hardware *hardware) {
	...
	char inserts_string[MAX_TRAP_STRING_LENGTH],deletes_string[MAX_TRAP_STRING_LENGTH],ageouts_string[MAX_TRAP_STRING_LENGTH],drops_string[MAX_TRAP_STRING_LENGTH];
