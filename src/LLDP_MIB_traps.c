...
void init_snmp_notifications() {
  ovsdb_idl_add_table(idl, &ovsrec_snmp_trap);
  ovsdb_idl_add_column(idl, &ovsrec_snmp_col_trap_community_name);
  ovsdb_idl_add_column(idl, &ovsrec_snmp_col_trap_receiver_address);
  ovsdb_idl_add_column(idl, &ovsrec_snmp_col_trap_receiver_port);
  ovsdb_idl_add_column(idl, &ovsrec_snmp_col_trap_type);
}
...
void send_lldpRemTablesChange(const char *lldpStatsRemTablesInserts_value,
