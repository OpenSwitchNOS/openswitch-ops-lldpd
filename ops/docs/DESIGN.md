...
The "lldpd" project from https://vincentbernat.github.io/lldpd/ is used for ops-lldpd daemon responsible for advertising and receiving LLDP packets from neighbors. The ability to interface with OVSDB for configurations and to push neighbor updates was added.
